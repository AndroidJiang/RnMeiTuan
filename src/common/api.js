...
export function recommendUrl(offset) {
    return 'http://api.meituan.com/group/v1/poi/select/cate/79?cityId=1&sort=smart&coupon=all&mpt_cate1=20&mpt_cate2=79&offset=' + offset + '&limit=20';
}
